...
@Route(path = "/MediaCodec/MediaCodecActivity")
public class MediaCodecActivity extends AppCompatActivity implements View.OnClickListener, Camera.PreviewCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.meidacodec_activity_main);
        try {
            surfaceViewEncode= (SurfaceView) findViewById(R.id.surfaceView_encode);
            surfaceViewDecode= (SurfaceView) findViewById(R.id.surfaceView_decode);
            ...
            e.printStackTrace();
            Toast.makeText(MediaCodecActivity.this,"Error",Toast.LENGTH_LONG).show();
        }
    }
